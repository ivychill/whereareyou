...
public class Constants {
	...
	public static final int MAIN_GET_CONTACT = 2;  //MainActivity 从通讯录获取联系人
	public static final int PICK_CONTACT = 3;      //从通讯录获取联系人
	public static final int SEARCH_DEST = 4;       //从地图搜索目的地址
	public static final int SHARE_DEST =  5;       //从地图搜索目的地址
	...
	public static final String LOCSMS = "想知道你在哪，同意请点击";
	public static final String LOCTIP = "使用说明: 选中联系人， 以上内容将通过短信方式发送，朋友收到后，打开短信中的链接信息，就可以返回他当前所在位置，该过程可能需要"
			+ "一定时间，您可以按下HOME键，切换到其他应用";

	public static final String DESTSMS = "目的地点: ";
	public static final String DESTTIP = "使用说明: 选中联系人， 以上内容将通过短信方式发送，朋友收到后，打开短信中的链接信息，即可看到目的信息";
...
//	public static final String WEIXIN_APP_ID = "wx9facda03786fc8af";	//测试
	...
	public static final String MAIN_ACTIVTY = "com.luyun.whereareyou.tracker_client.MainActivity";
}
