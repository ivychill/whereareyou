...
public class OverlayT extends ItemizedOverlay<OverlayItem> {  
    ...
    public OverlayT(Drawable marker, GeoPoint point, Context context, String name, String tips) {  
        super(boundCenterBottom(marker));  
        this.mContext = context;  
        this.marker = marker;  
        mGeoList.add(new OverlayItem(point, name, tips));  
        populate();  
    }  
...
//            paintText.setAlpha(30);
            paintText.setTextSize(20);  
            canvas.drawText(title, point.x -30, point.y-60, paintText);  
        }  
